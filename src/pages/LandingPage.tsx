...
function ProductMockup({ compact = false }: { compact?: boolean }) {
  return (
    <div className={`relative w-full ${compact ? 'max-w-sm' : 'max-w-xl'} mx-auto`}>
      ...
      {/* Floating badges - hidden on very small screens for compact, always shown on full */}
      <div className={compact ? 'hidden sm:block' : ''}>
        {[
          ...
          { text: 'Revenue Tracked', icon: TrendingUp, pos: 'bottom-16 sm:bottom-20 -left-2 sm:-left-6', delay: 1.0 },
          { text: 'Shift Complete', icon: CalendarDays, pos: '-bottom-2 right-2 sm:right-4', delay: 1.2 },
        ].map(b => (
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border/40 bg-background/80 backdrop-blur-lg">
      <div className="max-w-6xl mx-auto flex items-center justify-between h-14 sm:h-16 px-4 sm:px-6">
        <span className="text-lg sm:text-xl font-bold tracking-tight text-foreground" style={{ fontFamily: "'Manrope', sans-serif" }}>Locum Ops</span>
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <Section className="pt-10 sm:pt-14 md:pt-24 pb-8 sm:pb-10">
        <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-5 sm:space-y-6">
              <Anim>
                <span className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-3 sm:px-4 py-1.5 text-[10px] sm:text-xs font-semibold text-primary uppercase tracking-wider">
                  <Sparkles className="h-3 w-3 sm:h-3.5 sm:w-3.5" /> Now accepting founding beta users
                </span>
              </Anim>
              <Anim delay={0.05}>
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-extrabold leading-[1.1] sm:leading-[1.08] tracking-tight text-foreground" style={{ fontFamily: "'Manrope', sans-serif" }}>
          ...
          {/* Mobile mockup — shown below hero text on small screens */}
        ...
        <div className="max-w-3xl mx-auto">
          <Anim>
            <div className="rounded-2xl border border-border/40 bg-card p-5 sm:p-8 md:p-10">
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-foreground mb-4 sm:mb-5" style={{ fontFamily: "'Manrope', sans-serif" }}>
              ...
              <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl bg-muted/40 border border-border/30">
                ...
                <div>
                  <p className="font-semibold text-foreground text-sm sm:text-base">Founder & Relief Veterinarian</p>
                  <p className="text-xs sm:text-sm text-muted-foreground">Building Locum Ops from the trenches of real relief practice.</p>
                </div>
              </div>
            </div>
          </Anim>
      ...
      <Section id="problem">
        <div className="max-w-5xl mx-auto">
          <Anim className="text-center mb-8 sm:mb-14">
            <p className="text-sm font-semibold text-primary uppercase tracking-wider mb-2 sm:mb-3">The Problem</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground" style={{ fontFamily: "'Manrope', sans-serif" }}>
      ...
      <Section className="bg-muted/30" id="features">
        <div className="max-w-5xl mx-auto">
          <Anim className="text-center mb-8 sm:mb-14">
            <p className="text-sm font-semibold text-primary uppercase tracking-wider mb-2 sm:mb-3">The Platform</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground" style={{ fontFamily: "'Manrope', sans-serif" }}>
          ...
          <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-40px' }}
            ...
            {[
              ...
              <motion.div key={f.title} variants={fadeUp}
                className="rounded-2xl border border-border/40 bg-card p-5 sm:p-7 hover:shadow-lg hover:shadow-primary/5 transition-all hover:-translate-y-0.5 group">
      ...
      <Section id="how-it-works">
        <div className="max-w-5xl mx-auto">
          <Anim className="text-center mb-8 sm:mb-14">
            <p className="text-sm font-semibold text-primary uppercase tracking-wider mb-2 sm:mb-3">How It Works</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground" style={{ fontFamily: "'Manrope', sans-serif" }}>
              How Locum Ops works
            </h2>
          </Anim>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
              {[
                ...
                <motion.div key={s.step} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
                  ...
                  className="relative rounded-2xl border border-border/40 bg-card p-4 sm:p-6 text-center">
                  <div className="h-11 w-11 sm:h-14 sm:w-14 rounded-xl sm:rounded-2xl bg-primary/10 flex items-center justify-center mx-auto mb-3 sm:mb-4">
                    <s.icon className="h-5 w-5 sm:h-7 sm:w-7 text-primary" />
                  </div>
                  <div className="absolute -top-2.5 -right-1.5 sm:-top-3 sm:-right-2 h-6 w-6 sm:h-7 sm:w-7 rounded-full bg-primary text-primary-foreground text-[10px] sm:text-xs font-bold flex items-center justify-center">
                    {s.step}
                  </div>
                  <h3 className="font-bold text-foreground mb-1 sm:mb-2 text-xs sm:text-base">{s.title}</h3>
                  <p className="text-[11px] sm:text-sm text-muted-foreground leading-relaxed">{s.desc}</p>
                </motion.div>
              ))}
            </div>
          </Anim>
      ...
      <Section className="bg-muted/30" id="before-after">
        <div className="max-w-5xl mx-auto">
          <Anim className="text-center mb-8 sm:mb-14">
            <p className="text-sm font-semibold text-primary uppercase tracking-wider mb-2 sm:mb-3">The Difference</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground" style={{ fontFamily: "'Manrope', sans-serif" }}>
      ...
      <Section id="benefits">
        <div className="max-w-5xl mx-auto">
          <Anim className="text-center mb-8 sm:mb-14">
            <p className="text-sm font-semibold text-primary uppercase tracking-wider mb-2 sm:mb-3">Outcomes</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground" style={{ fontFamily: "'Manrope', sans-serif" }}>
      ...
      <Section className="bg-muted/30" id="ideal-user">
        <div className="max-w-3xl mx-auto text-center">
          <Anim>
            <p className="text-sm font-semibold text-primary uppercase tracking-wider mb-2 sm:mb-3">Who It's For</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-3 sm:mb-4" style={{ fontFamily: "'Manrope', sans-serif" }}>
              Built for independent relief veterinarians.
            </h2>
            <p className="text-muted-foreground text-base sm:text-lg mb-8 sm:mb-10">Especially those who:</p>
          </Anim>
          <Anim delay={0.1}>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-start">
            <Anim>
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-4 sm:mb-5" style={{ fontFamily: "'Manrope', sans-serif" }}>
      ...
      <Section className="bg-muted/30" id="faq">
        <div className="max-w-2xl mx-auto">
          <Anim className="text-center mb-8 sm:mb-10">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground" style={{ fontFamily: "'Manrope', sans-serif" }}>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-12">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 items-start">
            <div className="sm:col-span-3 md:col-span-1">
              <span className="text-lg sm:text-xl font-bold text-foreground" style={{ fontFamily: "'Manrope', sans-serif" }}>Locum Ops</span>
