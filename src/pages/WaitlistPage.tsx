        ...
        <Card>
          <CardContent className="pt-6">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="headache">What's the #1 admin headache you want solved? (optional)</Label>
                <Textarea id="headache" rows={3} value={headache} onChange={e => setHeadache(e.target.value)} />
              </div>
