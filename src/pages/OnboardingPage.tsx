  ...
  return (
    <>
      ...
      <a
        ...
        className="fixed bottom-3 right-3 z-50 rounded-full border border-border bg-background/90 px-3 py-1.5 text-xs text-muted-foreground shadow-sm backdrop-blur hover:text-foreground"
      >
        View setup status
      </a>
    </>
