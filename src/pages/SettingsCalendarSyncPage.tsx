...
export default function SettingsCalendarSyncPage() {
  ...
  // Auto-generate the subscription token so the URL is always available.
  useEffect(() => {
  ...
  return (
    <div>
      ...
      <div className="page-header">
        <h1 className="page-title">Sync your shifts to your calendar</h1>
      </div>
      ...
      <div className="space-y-6 max-w-4xl">
        ...
        {/* HOW THIS WORKS — Burnt Ochre accent */}
