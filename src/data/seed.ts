...
export const seedFacilities: Facility[] = [
  { id: 'c1', name: 'Greenfield Medical Center', status: 'active', address: '123 Oak St, Portland, OR 97201', timezone: 'America/Los_Angeles', notes: 'Great team, flexible scheduling', outreach_last_sent_at: fmt(addDays(today, -15)), tech_computer_info: 'Desktop login: locum1 / pass: Gr33nfield!', tech_wifi_info: 'Network: GFC-Staff, Password: wellness2026', tech_pims_info: 'Cornerstone — user: locum.vet / pass: temp1234', clinic_access_info: 'Front door code: 4521. Park in lot B. Keys at reception.', invoice_prefix: 'GMC', invoice_due_days: 14, invoice_email_to: 'billing@greenfield.com', invoice_email_cc: '', invoice_email_bcc: '' },
  { id: 'c2', name: 'Evergreen Health Clinic', status: 'active', address: '456 Pine Ave, Seattle, WA 98101', timezone: 'America/Los_Angeles', notes: 'Busy facility, weekend shifts common', outreach_last_sent_at: fmt(addDays(today, -30)), tech_computer_info: '', tech_wifi_info: 'EHC-Guest / evergreen99', tech_pims_info: 'eVetPractice — ask front desk for temp login', clinic_access_info: 'Ring buzzer at side entrance. After hours use code 7890.', invoice_prefix: 'EHC', invoice_due_days: 30, invoice_email_to: 'emily@evergreen-hc.com', invoice_email_cc: '', invoice_email_bcc: '' },
  { id: 'c3', name: 'Sunrise Care Center', status: 'prospect', address: '789 Elm Dr, Boise, ID 83701', timezone: 'America/Boise', notes: 'Initial outreach sent, awaiting response', outreach_last_sent_at: null, tech_computer_info: '', tech_wifi_info: '', tech_pims_info: '', clinic_access_info: '', invoice_prefix: 'SCC', invoice_due_days: 15, invoice_email_to: '', invoice_email_cc: '', invoice_email_bcc: '' },
  { id: 'c4', name: 'Mountain View Practice', status: 'active', address: '321 Birch Ln, Denver, CO 80201', timezone: 'America/Denver', notes: 'Monthly regular shifts', outreach_last_sent_at: fmt(addDays(today, -10)), tech_computer_info: 'Shared laptop in break room', tech_wifi_info: 'MVP-Clinic / mountain2026', tech_pims_info: 'Avimark — locum account pre-configured', clinic_access_info: 'Main entrance unlocked 7am–7pm. After hours call Rachel.', invoice_prefix: 'MVP', invoice_due_days: 14, invoice_email_to: '', invoice_email_cc: '', invoice_email_bcc: '' },
  { id: 'c5', name: 'Coastal Wellness Group', status: 'paused', address: '555 Beach Blvd, San Diego, CA 92101', timezone: 'America/Los_Angeles', notes: 'Paused due to staffing changes', outreach_last_sent_at: fmt(addDays(today, -60)), tech_computer_info: '', tech_wifi_info: '', tech_pims_info: '', clinic_access_info: '', invoice_prefix: 'CWG', invoice_due_days: 15, invoice_email_to: '', invoice_email_cc: '', invoice_email_bcc: '' },
];
