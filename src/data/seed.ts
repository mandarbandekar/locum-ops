...
export const seedFacilities: Facility[] = [
  ...
  // Platform/agency facility — does not generate invoices; payments confirmed via dashboard nudge
  { id: 'c6', name: 'Roo Veterinary Relief', status: 'active', address: 'Remote platform', timezone: 'America/Los_Angeles', notes: 'Relief shifts booked through the Roo platform — direct-deposit a few days after each shift.', outreach_last_sent_at: null, tech_computer_info: '', tech_wifi_info: '', tech_pims_info: '', clinic_access_info: '', invoice_prefix: 'ROO', invoice_due_days: 0, invoice_name_to: '', invoice_email_to: '', invoice_name_cc: '', invoice_email_cc: '', invoice_name_bcc: '', invoice_email_bcc: '', ...facDefaults, auto_generate_invoices: false, generates_invoices: false, engagement_type: 'third_party', source_name: 'Roo' },
];
...
export const seedShifts: Shift[] = [
  ...
  // June 2026 shifts
  { id: 'sj1', facility_id: 'c1', start_datetime: fmt(setTime(new Date(2026, 5, 2), 8)), end_datetime: fmt(setTime(new Date(2026, 5, 2), 18)), rate_applied: 850, notes: '', color: 'blue' },
  { id: 'sj2', facility_id: 'c1', start_datetime: fmt(setTime(new Date(2026, 5, 9), 8)), end_datetime: fmt(setTime(new Date(2026, 5, 9), 18)), rate_applied: 850, notes: '', color: 'blue' },
  { id: 'sj3', facility_id: 'c1', start_datetime: fmt(setTime(new Date(2026, 5, 16), 8)), end_datetime: fmt(setTime(new Date(2026, 5, 16), 18)), rate_applied: 850, notes: '', color: 'blue' },
  { id: 'sj4', facility_id: 'c1', start_datetime: fmt(setTime(new Date(2026, 5, 23), 8)), end_datetime: fmt(setTime(new Date(2026, 5, 23), 18)), rate_applied: 850, notes: 'Last week of month', color: 'blue' },
  { id: 'sj5', facility_id: 'c2', start_datetime: fmt(setTime(new Date(2026, 5, 4), 7)), end_datetime: fmt(setTime(new Date(2026, 5, 4), 19)), rate_applied: 900, notes: '', color: 'green' },
  { id: 'sj6', facility_id: 'c2', start_datetime: fmt(setTime(new Date(2026, 5, 11), 7)), end_datetime: fmt(setTime(new Date(2026, 5, 11), 19)), rate_applied: 900, notes: '', color: 'green' },
  { id: 'sj7', facility_id: 'c2', start_datetime: fmt(setTime(new Date(2026, 5, 18), 7)), end_datetime: fmt(setTime(new Date(2026, 5, 18), 19)), rate_applied: 900, notes: 'Extended coverage', color: 'green' },
  { id: 'sj8', facility_id: 'c2', start_datetime: fmt(setTime(new Date(2026, 5, 20), 8)), end_datetime: fmt(setTime(new Date(2026, 5, 20), 16)), rate_applied: 1200, notes: 'Weekend shift', color: 'orange' },
  { id: 'sj9', facility_id: 'c4', start_datetime: fmt(setTime(new Date(2026, 5, 5), 9)), end_datetime: fmt(setTime(new Date(2026, 5, 5), 17)), rate_applied: 800, notes: '', color: 'purple' },
  { id: 'sj10', facility_id: 'c4', start_datetime: fmt(setTime(new Date(2026, 5, 12), 9)), end_datetime: fmt(setTime(new Date(2026, 5, 12), 17)), rate_applied: 800, notes: '', color: 'purple' },
  { id: 'sj11', facility_id: 'c4', start_datetime: fmt(setTime(new Date(2026, 5, 19), 9)), end_datetime: fmt(setTime(new Date(2026, 5, 19), 17)), rate_applied: 800, notes: '', color: 'purple' },
  { id: 'sj12', facility_id: 'c3', start_datetime: fmt(setTime(new Date(2026, 5, 8), 8)), end_datetime: fmt(setTime(new Date(2026, 5, 8), 17)), rate_applied: 750, notes: 'First shift at Sunrise', color: 'teal' },
  { id: 'sj13', facility_id: 'c3', start_datetime: fmt(setTime(new Date(2026, 5, 22), 8)), end_datetime: fmt(setTime(new Date(2026, 5, 22), 17)), rate_applied: 750, notes: '', color: 'teal' },
  // July 2026 shifts
  { id: 'sjl1', facility_id: 'c1', start_datetime: fmt(setTime(new Date(2026, 6, 1), 8)), end_datetime: fmt(setTime(new Date(2026, 6, 1), 18)), rate_applied: 850, notes: '', color: 'blue' },
  { id: 'sjl2', facility_id: 'c1', start_datetime: fmt(setTime(new Date(2026, 6, 7), 8)), end_datetime: fmt(setTime(new Date(2026, 6, 7), 18)), rate_applied: 850, notes: '', color: 'blue' },
  { id: 'sjl3', facility_id: 'c1', start_datetime: fmt(setTime(new Date(2026, 6, 14), 8)), end_datetime: fmt(setTime(new Date(2026, 6, 14), 18)), rate_applied: 850, notes: '', color: 'blue' },
  { id: 'sjl4', facility_id: 'c1', start_datetime: fmt(setTime(new Date(2026, 6, 21), 8)), end_datetime: fmt(setTime(new Date(2026, 6, 21), 18)), rate_applied: 850, notes: '', color: 'blue' },
  { id: 'sjl5', facility_id: 'c1', start_datetime: fmt(setTime(new Date(2026, 6, 28), 8)), end_datetime: fmt(setTime(new Date(2026, 6, 28), 18)), rate_applied: 850, notes: 'End of month', color: 'blue' },
  { id: 'sjl6', facility_id: 'c2', start_datetime: fmt(setTime(new Date(2026, 6, 2), 7)), end_datetime: fmt(setTime(new Date(2026, 6, 2), 19)), rate_applied: 900, notes: '', color: 'green' },
  { id: 'sjl7', facility_id: 'c2', start_datetime: fmt(setTime(new Date(2026, 6, 9), 7)), end_datetime: fmt(setTime(new Date(2026, 6, 9), 19)), rate_applied: 900, notes: '', color: 'green' },
  { id: 'sjl8', facility_id: 'c2', start_datetime: fmt(setTime(new Date(2026, 6, 16), 7)), end_datetime: fmt(setTime(new Date(2026, 6, 16), 19)), rate_applied: 900, notes: '', color: 'green' },
  { id: 'sjl9', facility_id: 'c2', start_datetime: fmt(setTime(new Date(2026, 6, 23), 7)), end_datetime: fmt(setTime(new Date(2026, 6, 23), 19)), rate_applied: 900, notes: '', color: 'green' },
  { id: 'sjl10', facility_id: 'c4', start_datetime: fmt(setTime(new Date(2026, 6, 3), 9)), end_datetime: fmt(setTime(new Date(2026, 6, 3), 17)), rate_applied: 800, notes: '', color: 'purple' },
  { id: 'sjl11', facility_id: 'c4', start_datetime: fmt(setTime(new Date(2026, 6, 10), 9)), end_datetime: fmt(setTime(new Date(2026, 6, 10), 17)), rate_applied: 800, notes: '', color: 'purple' },
  { id: 'sjl12', facility_id: 'c4', start_datetime: fmt(setTime(new Date(2026, 6, 17), 9)), end_datetime: fmt(setTime(new Date(2026, 6, 17), 17)), rate_applied: 800, notes: '', color: 'purple' },
  { id: 'sjl13', facility_id: 'c4', start_datetime: fmt(setTime(new Date(2026, 6, 24), 9)), end_datetime: fmt(setTime(new Date(2026, 6, 24), 17)), rate_applied: 800, notes: '', color: 'purple' },
  { id: 'sjl14', facility_id: 'c3', start_datetime: fmt(setTime(new Date(2026, 6, 6), 8)), end_datetime: fmt(setTime(new Date(2026, 6, 6), 17)), rate_applied: 750, notes: '', color: 'teal' },
  { id: 'sjl15', facility_id: 'c3', start_datetime: fmt(setTime(new Date(2026, 6, 13), 8)), end_datetime: fmt(setTime(new Date(2026, 6, 13), 17)), rate_applied: 750, notes: '', color: 'teal' },
  { id: 'sjl16', facility_id: 'c3', start_datetime: fmt(setTime(new Date(2026, 6, 20), 8)), end_datetime: fmt(setTime(new Date(2026, 6, 20), 17)), rate_applied: 750, notes: '', color: 'teal' },
];
